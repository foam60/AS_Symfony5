 ...
 */
class getDocumentCategorieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocumentCategorieRepository' shared autowired service.
     *
     * @return \App\Repository\DocumentCategorieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocumentCategorieRepository.php';

        return $container->privates['App\\Repository\\DocumentCategorieRepository'] = new \App\Repository\DocumentCategorieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
